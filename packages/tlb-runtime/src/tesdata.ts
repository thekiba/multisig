...
export const groupCorpus: TLBCorpus = {
  "Built-in types": [
    [
      ...
      [
        [
          { kind: "OneNatParam", x: 42 },
          "b5ee9c724101010100060000080000002a05a6f044",
        ],
      ],
    ],
    [
        ...
        [
          {
            ...
            x: {
              kind: "HashmapVarKey",
              n: 5,
              x: Dictionary.empty(Dictionary.Keys.BigUint(7))
                .set(3n, 6)
                .set(7n, 9),
            },
          },
        ...
        [
          {
            kind: "AnyAddressUser",
            x: Address.parse(
              "EQBmzW4wYlFW0tiBgj5sP1CgSlLdYs-VpjPWM7oPYPYWQEdT",
            ),
          },
        ...
        [
          {
            ...
            x: {
              ...
              other: {
                kind: "Either_right",
                value: { kind: "OneComb", t: 5, x: 5 },
              },
              init: {
                kind: "Maybe_just",
                value: { kind: "Either_right", value: 4 },
              },
            },
          },
        ...
        [
          {
            ...
            msg: {
              kind: "Maybe_just",
              value: beginCell().storeUint(676, 10).endCell(),
            },
          },
        ...
        [
          {
            ...
            msg: {
              ...
              y: {
                kind: "Maybe_just",
                value: beginCell().storeUint(3, 32).endCell(),
              },
            },
          },
    ...
    [
      ...
      [
        [
          ...
          "b5ee9c7241010101000700000980000002c098d97633",
        ],
        [
          { kind: "ConditionalField", a: 0 },
          "b5ee9c7241010101000300000140f6d24034",
        ],
      ],
    ],
    [
      ...
      [
        [
          ...
          "b5ee9c7241010101000700000914000000160ae584e0",
        ],
        [
          { kind: "BitSelection", a: 8 },
          "b5ee9c7241010101000700000920000000163e8f4b94",
        ],
      ],
    ],
    [
  ...
  "Constructor Tags": [
    ...
    [
      ...
      [
        [
          { kind: "SharpTag", x: 3 },
          "b5ee9c7241010101000700000af40000000306f7ccb3",
        ],
      ],
    ],
    [
      ...
      [
        [
          { kind: "DollarTag", x: 3 },
          "b5ee9c72410101010007000009b000000038480a0ef9",
        ],
      ],
    ],
    [
    ...
    [
      ...
      [
        [
          ...
          "b5ee9c7241010101000a00001009d97e7a00000003dcb97fc6",
        ],
        [
  ...
  "Correct tag calculation": [
    [
      ...
      [
        [
          { kind: "LeastSignificantBitRemoved" },
          "b5ee9c72410101010004000003020157409964",
        ],
      ],
    ],
    [
      ...
      [
        [
          ...
          "b5ee9c7241010101000a00001009d97e7a0000002aceec709e",
        ],
        [
